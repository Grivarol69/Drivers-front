...
const Form = () => {
  ...
  //* primer paso traemos del Store todos los Teams
  ...
  //*si los Teams no existen llamamos a la action de Redux 
  useEffect(() => {
    if (!teams.length) {
      dispatch(getTeams());
    }
  ...
  //*creamos la funcion para manejar el Select de Teams

  const handleSelectChange = (event) => {
    if (input.teams.includes(event.target.value)) {
      window.alert("Team already selected!");
    } else if (input.teams.lenth >= 7) {
      window.alert("Max. 6 teams");
    } else {
      setInput({
        ...input,
  ...
  //*creamos la función para eliminar un elemento de Select de Teams
          ...
          <div className="card-text">
            ...
            >
              ...
              <Input>
                ...
                >Name: </label>
                <label className="input_error">{errors.name && errors.name}</label>
              </Input>
